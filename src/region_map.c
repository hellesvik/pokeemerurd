...
static u8 GetMapsecType(mapsec_u16_t mapSecId)
{
#if TEST_FLY_DESTINATIONS_UNRESTRICTED
#define CITY_FLY_TYPE(flag) MAPSECTYPE_CITY_CANFLY
#else
#define CITY_FLY_TYPE(flag) (FlagGet(flag) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY)
#endif
    switch (mapSecId)
    {
    case MAPSEC_NONE:
    ...
    case MAPSEC_LITTLEROOT_TOWN:
        return CITY_FLY_TYPE(FLAG_VISITED_LITTLEROOT_TOWN);
    case MAPSEC_OLDALE_TOWN:
        return CITY_FLY_TYPE(FLAG_VISITED_OLDALE_TOWN);
    case MAPSEC_DEWFORD_TOWN:
        return CITY_FLY_TYPE(FLAG_VISITED_DEWFORD_TOWN);
    case MAPSEC_LAVARIDGE_TOWN:
        return CITY_FLY_TYPE(FLAG_VISITED_LAVARIDGE_TOWN);
    case MAPSEC_FALLARBOR_TOWN:
        return CITY_FLY_TYPE(FLAG_VISITED_FALLARBOR_TOWN);
    case MAPSEC_VERDANTURF_TOWN:
        return CITY_FLY_TYPE(FLAG_VISITED_VERDANTURF_TOWN);
    case MAPSEC_PACIFIDLOG_TOWN:
        return CITY_FLY_TYPE(FLAG_VISITED_PACIFIDLOG_TOWN);
    case MAPSEC_PETALBURG_CITY:
        return CITY_FLY_TYPE(FLAG_VISITED_PETALBURG_CITY);
    case MAPSEC_SLATEPORT_CITY:
        return CITY_FLY_TYPE(FLAG_VISITED_SLATEPORT_CITY);
    case MAPSEC_MAUVILLE_CITY:
        return CITY_FLY_TYPE(FLAG_VISITED_MAUVILLE_CITY);
    case MAPSEC_RUSTBORO_CITY:
        return CITY_FLY_TYPE(FLAG_VISITED_RUSTBORO_CITY);
    case MAPSEC_FORTREE_CITY:
        return CITY_FLY_TYPE(FLAG_VISITED_FORTREE_CITY);
    case MAPSEC_LILYCOVE_CITY:
        return CITY_FLY_TYPE(FLAG_VISITED_LILYCOVE_CITY);
    case MAPSEC_MOSSDEEP_CITY:
        return CITY_FLY_TYPE(FLAG_VISITED_MOSSDEEP_CITY);
    case MAPSEC_SOOTOPOLIS_CITY:
        return CITY_FLY_TYPE(FLAG_VISITED_SOOTOPOLIS_CITY);
    case MAPSEC_EVER_GRANDE_CITY:
        return CITY_FLY_TYPE(FLAG_VISITED_EVER_GRANDE_CITY);
