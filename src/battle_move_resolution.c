...
static const enum Move sSpecialMetronomeMoves[] =
{
    MOVE_AEROBLAST,
    MOVE_SACRED_FIRE,
    MOVE_PSYCHO_BOOST,
...
static enum Move GetMetronomeMove(void)
{
    ...
    if (RandomUniform(RNG_METRONOME_SPECIAL_CHANCE, 0, 3) == 0)
        return *(const enum Move *)RandomElementArray(RNG_METRONOME, sSpecialMetronomeMoves, sizeof(*sSpecialMetronomeMoves), ARRAY_COUNT(sSpecialMetronomeMoves));
