...
const struct SpeciesInfo gSpeciesInfoGen2[] =
{
    ...
    [SPECIES_QUILAVA] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 36, SPECIES_TYPHLOSION, CONDITIONS({IF_NOT_IN_TRICK_HOUSE})}
                            #if P_HISUIAN_FORMS
                                ,{EVO_LEVEL, 36, SPECIES_TYPHLOSION_HISUI, CONDITIONS({IF_IN_TRICK_HOUSE})}
                            #endif
                            ),
    },
...
#define UNOWN_MISC_INFO(letter, _noFlip, frontWidth, frontHeight, backWidth, backHeight, backYOffset)   \
    ...
    [SPECIES_URSARING] =
    {
        ...
        .evolutions = EVOLUTION({EVO_ITEM, ITEM_PEAT_BLOCK, SPECIES_URSALUNA, CONDITIONS({IF_IN_TRICK_HOUSE}, {IF_TIME, TIME_NIGHT})},
    ...
    #if P_GEN_8_CROSS_EVOS
        .evolutions = EVOLUTION({EVO_LEVEL, 0, SPECIES_WYRDEER}),
    #endif
    },
