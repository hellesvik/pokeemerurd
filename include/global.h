...
#define FORK_ITEM_RANDOMIZER_GYM_LEADER_SOURCE_START 428
#define FORK_ITEM_RANDOMIZER_GYM_LEADER_SOURCE_COUNT 8
#define FORK_ITEM_RANDOMIZER_SOURCE_COUNT (FORK_ITEM_RANDOMIZER_GYM_LEADER_SOURCE_START + FORK_ITEM_RANDOMIZER_GYM_LEADER_SOURCE_COUNT + 1)
#define FORK_ITEM_RANDOMIZER_POOL_COUNT 384
